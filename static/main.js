...
// the length of the list isn't const because we can add more to thr list
...
addbtn.addEventListener('click', ()=> {
    ...
    // inputSpace.value = '';
        if (document.querySelector('input').value.length==0) {
            ...
            `
            // here we auto update the variable and update the pending task too
            lists = document.getElementsByClassName('todos');
            pending.textContent = lists.length;
            inputSpace.value = '';
        }
